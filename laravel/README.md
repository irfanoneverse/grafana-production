...
cat .env.otel.example >> /home/forge/gateway.oneone.com/current/.env
```
...
```bash
# Adjust the path to your Laravel project directory
cp TraceIdMiddleware.php /home/forge/gateway.oneone.com/current/app/Http/Middleware/TraceIdMiddleware.php
```
